...
const ProfileCard = () => {
    ...
    return (
        <div className={`transition-all duration-300 ease-in-out ${expanded ? 'px-[25vw] sm:scale-100 sm:px-[10vw] sm:pt-10 py-4 w-full h-fit items-left flex-col pb-[5vh]' : 'mt-8 p-4 sm:rounded-[15px] sm:mt-[6vh] sm:scale-[90%]  w-max gap-4 h-min flex-row'} bg-background shadow-md rounded-lg  flex sm:flex-col`}>
